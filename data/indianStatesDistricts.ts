...
// This file contains a comprehensive list of Indian states and their districts
...
export const indianStatesDistricts: StateDistrict[] = [
  {
...
export const getDistrictsByState = (state: string): string[] => {
  const stateData = indianStatesDistricts.find(
...
export const getAllStates = (): string[] => {
  return indianStatesDistricts.map(s => s.state);
};
